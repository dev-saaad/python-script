...
class ReportNewClass(DataTable):
    ...
    def compute_tables(self):
        ...
        if(self.inputs['isAOP'] == "Da"):
            data8 = ((self.df.loc[3, "Izkazi2_E"]/self.predopostavkeList['St_Mesecev'][0]*12)/self.df.loc[3, "Izkazi2_D"])-1
        else:
        ...
        for i in range(1, 346):
            ...
            if(i == 3): 
                self.df.loc[i, "Report_A"] = self.inputs['Dolznik']
            if(i == 5):
                self.df.loc[i, "Report_A"] = self.inputs['Naslov']
            if(i == 6):
                self.df.loc[i, "Report_B"] = self.inputs['Maticna_stevilka']
            if(i == 7):
                self.df.loc[i, "Report_B"] = self.inputs['Davcna_stevilka']

            if(i == 13):
                self.df.loc[i, "Report_J"] = self.inputs['Priporocen_limit_W18']
                self.df.loc[i, "Report_K"] = self.inputs['Priporocen_limit_W19']

            if(i == 16):
                self.df.loc[i, "Report_K"] = self.inputs['Povprecni_dnevi_zamud']
                self.df.loc[i, "Report_O"] = self.inputs['Max_dnevi_zamud']
            
            if(i == 17):
                self.df.loc[i, "Report_F"] = self.inputs['Cesija_K1']

            
            if(i == 19):
                if(self.inputs['isAOP'] == "Da"):
                    if(data8 < 0-self.inputs['Pogoj']):
                ...
                self.df.loc[i, "Report_O"] = round(self.inputs['Pogoj']/100)
            
            if(i == 20):
                self.df.loc[i, "Report_H"] = min(self.df.loc[i-1, "Report_H"] , self.inputs['Priporocen_limit'])


            if(i == 22):
                self.df.loc[i, "Report_K"] = self.inputs['Stevilo_blokiranih_TRR']
                self.df.loc[i, "Report_O"] = self.inputs['Stevilo_rezervacij']
            
            if(i == 25):
                self.df.loc[i, "Report_K"] = self.inputs['Lastniki_Tozeni']
                self.df.loc[i, "Report_O"] = self.inputs['Zastopniki_Tozeci']

            if(i == 27):
                self.df.loc[i, "Report_B"] = self.predopostavkeList['St_Mesecev'][0]
            if(i == 29):
                self.df.loc[i, "Report_B"] = self.predopostavke[0]['Obdobja']
                self.df.loc[i, "Report_C"] = self.predopostavke[1]['Obdobja']
                self.df.loc[i, "Report_D"] = self.predopostavke[2]['Obdobja']
                self.df.loc[i, "Report_E"] = self.predopostavke[3]['Obdobja']
                if(len(self.predopostavke) > 4):
                    self.df.loc[i, "Report_F"] = self.predopostavke[4]['Obdobja']
...
########################################################
            if(i == 34):
                self.df.loc[i, "Report_B"] = self.predopostavkeList['PL'][0]
                self.df.loc[i, "Report_C"] = self.predopostavkeList['PL'][1]
                self.df.loc[i, "Report_D"] = self.predopostavkeList['PL'][2]
                self.df.loc[i, "Report_E"] = self.predopostavkeList['PL'][3]
                self.df.loc[i, "Report_F"] = self.predopostavkeList['PL'][4]
            ...
            if(i == 39 or i == 49 or i == 59):
                if(self.inputs['isAOP'] == "Da"):
                    self.df.loc[i, "Report_D"] = self.predopostavkeList['PL'][2]
                    self.df.loc[i, "Report_F"] = self.predopostavkeList['PL'][3]
                    self.df.loc[i, "Report_H"] = self.predopostavkeList['PL'][4]
                else:
                    self.df.loc[i, "Report_D"] = self.predopostavkeList['PL'][1]
                    self.df.loc[i, "Report_F"] = self.predopostavkeList['PL'][2]
                    self.df.loc[i, "Report_H"] = self.predopostavkeList['PL'][3]
            ...
            if(i == 66):
                ...
                if(self.df.loc[i-1, "Report_H"] > 0):
                    ...
                    self.df.loc[i, "Report_H"] = round(-self.df.loc[i-1, "Report_H"] / (self.df.loc[i-23, "Report_H"]/self.predopostavkeList['St_Mesecev'][0]*12), 1)
            ...
            if(i == 67):
                ...
                if(self.df.loc[i-3, "Report_H"] == 0):
                    ...
                    self.df.loc[i, "Report_H"] = round((self.df.loc[i-24, "Report_H"]/self.predopostavkeList['St_Mesecev'][0]*12) / (-self.df.loc[i-3, "Report_H"]), 1)
            ...
            if(i == 76):
                self.df.loc[i, "Report_F"] = self.predopostavkeList['PL'][0]
                self.df.loc[i, "Report_H"] = self.predopostavkeList['PL'][1]
                self.df.loc[i, "Report_J"] = self.predopostavkeList['PL'][2]
                self.df.loc[i, "Report_N"] = self.predopostavkeList['PL'][3]
                self.df.loc[i, "Report_R"] = self.predopostavkeList['PL'][4]
            ...
            # Table 3
            if(i == 146):
                self.df.loc[i, "Report_F"] = self.predopostavke[0]['Obdobja']
                self.df.loc[i, "Report_H"] = self.predopostavke[1]['Obdobja']
                self.df.loc[i, "Report_J"] = self.predopostavke[2]['Obdobja']
                self.df.loc[i, "Report_N"] = self.predopostavke[3]['Obdobja']
                if(len(self.predopostavke) > 4):
                    self.df.loc[i, "Report_R"] = self.predopostavke[4]['Obdobja']
            ...
            if(i == 215):
                if(self.inputs['isAOP'] == "Da"):
                    self.df.loc[i, "Report_D"] = self.predopostavke[2]['Obdobja'] 
                    self.df.loc[i, "Report_F"] = self.predopostavke[3]['Obdobja']
                    self.df.loc[i, "Report_H"] = self.predopostavke[4]['Obdobja']
                else:
                    self.df.loc[i, "Report_D"] = self.predopostavke[1]['Obdobja']
                    self.df.loc[i, "Report_F"] = self.predopostavke[2]['Obdobja']
                    self.df.loc[i, "Report_H"] = self.predopostavke[3]['Obdobja']
