...
class KazalnikiNewClass(DataTable):
    ...
    def compute_tables(self):
        ...
        # izkaziCol = ["Izkazi_A", "Izkazi_B", "Izkazi_C"]
        # izkazi2Col = ["Izkazi2_A", "Izkazi2_B", "Izkazi2_C"]

        for i in range(len(self.predopostavke)):
            ...
            if( i == 0 ):
                self.df.loc[i, "Kazalniki_14"] = self.divide(-self.df.loc[v2al87, izkazi2Col[i]]/self.predopostavkeList['St_Mesecev'][0]*12, self.df.loc[val26, izkaziCol[i]]/2)

                self.df.loc[i, "Kazalniki_15"] = self.divide( (self.df.loc[v2al85, izkazi2Col[i]] + self.df.loc[v2al91, izkazi2Col[i]])/self.predopostavkeList['St_Mesecev'][0]*12 , self.df.loc[val32, izkaziCol[i]]/2)           

                self.df.loc[i, "Kazalniki_16"] = self.divide((-self.df.loc[v2al87, izkazi2Col[i]] - self.df.loc[v2al92, izkazi2Col[i]] - self.df.loc[v2al93, izkazi2Col[i]] - self.df.loc[v2al94, izkazi2Col[i]])/self.predopostavkeList['St_Mesecev'][0]*12, self.df.loc[val65, izkaziCol[i]]/2)

                self.df.loc[i, "Kazalniki_19"] = round( (self.df.loc[val26, izkaziCol[i]]/2) / ( (-self.df.loc[v2al87, izkazi2Col[i]])/self.predopostavkeList['St_Mesecev'][0]*12) * 365)

                self.df.loc[i, "Kazalniki_20"] = round( (self.df.loc[val32, izkaziCol[i]]/2) / (( self.df.loc[v2al85, izkazi2Col[i]] + self.df.loc[v2al91, izkazi2Col[i]])/self.predopostavkeList['St_Mesecev'][0]*12) * 365)

                self.df.loc[i, "Kazalniki_21"] = -round( (self.df.loc[val65, izkaziCol[i]]/2) / (( - self.df.loc[v2al87, izkazi2Col[i]] - self.df.loc[v2al92, izkazi2Col[i]] - self.df.loc[v2al93, izkazi2Col[i]] - self.df.loc[v2al94, izkazi2Col[i]]) / self.predopostavkeList['St_Mesecev'][0]*12) * 365)
            else:
                self.df.loc[i, "Kazalniki_14"] = self.divide(-self.df.loc[v2al87, izkazi2Col[i]]/self.predopostavkeList['St_Mesecev'][0+i]*12, (self.df.loc[val26, izkaziCol[i]] + self.df.loc[val26, izkaziCol[i-1]])/2)

                self.df.loc[i, "Kazalniki_15"] = self.divide( (self.df.loc[v2al85, izkazi2Col[i]] + self.df.loc[v2al91, izkazi2Col[i]])/self.predopostavkeList['St_Mesecev'][0+i]*12 , (self.df.loc[val32, izkaziCol[i]] + self.df.loc[val32, izkaziCol[i-1]])/2)

                self.df.loc[i, "Kazalniki_16"] = self.divide((-self.df.loc[v2al87, izkazi2Col[i]] - self.df.loc[v2al92, izkazi2Col[i]] - self.df.loc[v2al93, izkazi2Col[i]] - self.df.loc[v2al94, izkazi2Col[i]])/self.predopostavkeList['St_Mesecev'][0+i]*12, (self.df.loc[val65, izkaziCol[i]] + self.df.loc[val65, izkaziCol[i-1]])/2)

                self.df.loc[i, "Kazalniki_19"] = round( ((self.df.loc[val26, izkaziCol[i]]+self.df.loc[val26, izkaziCol[i-1]])/2) / (( -self.df.loc[v2al87, izkazi2Col[i]])/self.predopostavkeList['St_Mesecev'][0+i]*12) * 365)

                self.df.loc[i, "Kazalniki_20"] = round( ((self.df.loc[val32, izkaziCol[i]] + self.df.loc[val32, izkaziCol[i-1]])/2) / (( self.df.loc[v2al85, izkazi2Col[i]] + self.df.loc[v2al91, izkazi2Col[i]])/self.predopostavkeList['St_Mesecev'][0+i]*12)  * 365)

                self.df.loc[i, "Kazalniki_21"] = -round( ((self.df.loc[val65, izkaziCol[i]] + self.df.loc[val65, izkaziCol[i-1]])/2) / (( -self.df.loc[v2al87, izkazi2Col[i]] - self.df.loc[v2al92, izkazi2Col[i]] - self.df.loc[v2al93, izkazi2Col[i]] - self.df.loc[v2al94, izkazi2Col[i]])/self.predopostavkeList['St_Mesecev'][0+i]*12) * 365)
            ...
            if( i >= 0 and i <= 3 and self.df.loc[val36, izkaziCol[i]] ):
                ...
                self.df.loc[i, "Kazalniki_36"] = round(
                    1.2*((self.df.loc[val34, izkaziCol[i]] + self.df.loc[val35, izkaziCol[i]])/self.df.loc[val36, izkaziCol[i]]) + 1.4*((self.df.loc[val43, izkaziCol[i]])/self.df.loc[val36, izkaziCol[i]]) + 3.3*((self.df.loc[v2al100, izkazi2Col[i]]/self.predopostavkeList['St_Mesecev'][i]*12)/self.df.loc[val36, izkaziCol[i]]) + 0.6*((self.df.loc[val45, izkaziCol[i]])/(self.df.loc[val48, izkaziCol[i]] + self.df.loc[val57, izkaziCol[i]] + self.df.loc[val66, izkaziCol[i]] + self.df.loc[val67, izkaziCol[i]])) + 0.999* ((self.df.loc[v2al85, izkazi2Col[i]]/self.predopostavkeList['St_Mesecev'][i]*12)/self.df.loc[val36, izkaziCol[i]])  
                , 2)
            else:
            ...
            if( i >= 0 and i <= 3 ):
                ...
                self.df.loc[i, "Kazalniki_53"] = round(
                    (1.5*((self.df.loc[v2al95, izkazi2Col[i]] / self.predopostavkeList['St_Mesecev'][i]*12) / (self.df.loc[val57, izkaziCol[i]]+self.df.loc[val66, izkaziCol[i]]))) + (0.08*(self.df.loc[val36, izkaziCol[i]] / (self.df.loc[val57, izkaziCol[i]] + self.df.loc[val66, izkaziCol[i]] ))) + (10*((self.df.loc[v2al110, izkazi2Col[i]]/self.predopostavkeList['St_Mesecev'][i]*12) / self.df.loc[val36, izkaziCol[i]])) + (5*(self.df.loc[v2al110, izkazi2Col[i]]/self.df.loc[v2al85, izkazi2Col[i]])) + (0.3*(self.df.loc[val26, izkaziCol[i]]/(self.df.loc[v2al85, izkazi2Col[i]]/self.predopostavkeList['St_Mesecev'][i]*12))) + (0.1 *((self.df.loc[v2al85, izkazi2Col[i]] /self.predopostavkeList['St_Mesecev'][i]*12) / self.df.loc[val36, izkaziCol[i]])), 2)
            else:
            ...
            if( i >= 0 and i <= 3 and self.df.loc[val36, izkaziCol[i]] and self.df.loc[val66, izkaziCol[i]] ):
                ...
                self.df.loc[i, "Kazalniki_90"] = round(
                    ((-4.5*((self.df.loc[v2al110, izkazi2Col[i]]/self.predopostavkeList['St_Mesecev'][i]*12)/self.df.loc[val36, izkaziCol[i]])) + (5.7 * (( self.df.loc[val57, izkaziCol[i]] + self.df.loc[val66, izkaziCol[i]] + self.df.loc[val67, izkaziCol[i]])/self.df.loc[val36, izkaziCol[i]])) - (0.004*(self.df.loc[val34, izkaziCol[i]]/ self.df.loc[val66, izkaziCol[i]]))), 2)
            else:
            ...
            self.df.loc[i, "Kazalniki_114"] = round((self.df.loc[v2al85, izkazi2Col[i]] + self.df.loc[v2al93, izkazi2Col[i]]) / self.predopostavkeList['St_Mesecev'][0+i])
        ...
        for i in range(len(izkaziCol)):
            ...
            self.df.loc[i, "Kazalniki_39"] = self.inputs['Kazalniki_B39']
            self.df.loc[i, "Kazalniki_40"] = self.inputs['Kazalniki_B40']
            ...
            self.df.loc[i, "Kazalniki_45"] = self.inputs['Kazalniki_B45']
            self.df.loc[i, "Kazalniki_62"] = -0.5-self.inputs['Kazalniki_B56']
            self.df.loc[i, "Kazalniki_63"] = self.inputs['Kazalniki_B57']
            self.df.loc[i, "Kazalniki_64"] = self.inputs['Kazalniki_B58'] - self.inputs['Kazalniki_B57']
            self.df.loc[i, "Kazalniki_65"] = self.inputs['Kazalniki_B59'] - self.inputs['Kazalniki_B58']
            self.df.loc[i, "Kazalniki_66"] = 5 - self.inputs['Kazalniki_B59']
            self.df.loc[i, "Kazalniki_79"] = self.inputs['Kazalniki_B79']
            self.df.loc[i, "Kazalniki_82"] = self.df.loc[i, "Kazalniki_79"]
            self.df.loc[i, "Kazalniki_83"] = 1 - self.df.loc[i, "Kazalniki_79"]
            self.df.loc[i, "Kazalniki_104"] = self.inputs['Kazalniki_B99']
            self.df.loc[i, "Kazalniki_105"] = self.inputs['Kazalniki_B100'] - self.inputs['Kazalniki_B99']
            self.df.loc[i, "Kazalniki_106"] = self.inputs['Kazalniki_B101'] - self.inputs['Kazalniki_B100']
        
        for i in range(0, 5):
            self.df.loc[i, "Kazalniki_97"] = self.df.loc[40, "Weinrich_"+chr(i+65)]
